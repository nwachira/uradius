...
function MpesatillStk_save_config()
{
    ...
    $mpesa_till_transaction = _post('mpesa_till_transaction');
    $d = ORM::for_table('tbl_appconfig')->where('setting', 'mpesa_till_consumer_key')->find_one();
    if ($d) {
        $d->value = $mpesa_till_consumer_key;
        $d->save();
    } else {
    ...
    if ($d) {
        $d->value = $mpesa_till_consumer_secret;
        $d->save();
    } else {
        $d = ORM::for_table('tbl_appconfig')->create();
    ...
    if ($d) {
        $d->value = $mpesa_till_business_code;
        $d->save();
    } else {
        $d = ORM::for_table('tbl_appconfig')->create();
    ...
    $d = ORM::for_table('tbl_appconfig')->where('setting', 'mpesa_till_env')->find_one();
    if ($d) {
        $d->value = $mpesa_till_env;
        $d->save();
    } else {
        $d = ORM::for_table('tbl_appconfig')->create();
        $d->setting = 'mpesa_till_env';
        $d->value = $mpesa_till_env;
        $d->save();
    }
    $d = ORM::for_table('tbl_appconfig')->where('setting', 'mpesa_till_transaction')->find_one();
    if ($d) {
        $d->value = $mpesa_till_transaction;
        $d->save();
    } else {
        $d = ORM::for_table('tbl_appconfig')->create();
        $d->setting = 'mpesa_till_transaction';
        $d->value = $mpesa_till_transaction;
        $d->save();
    }
